...
import com.ours.constant.Root;
import com.ours.entity.SysUser;
import com.ours.entity.SysUserRole;
import com.ours.service.SysRoleService;
import com.ours.service.SysUserRoleService;
...
public class SysUserController {
    ...
    @PostMapping("queryBranchByUser")
    public ServiceMessage queryBranchByUser(@RequestBody String body) {
    	JSONObject json = JSON.parseObject(body);
    	String uname = json.getString("uName");
        ServiceMessage result = new ServiceMessage();
        
        Map<String, Object> data = sysUserService.queryBranchByUser(uname);
        result.put(Const.DATA_KEY, data);
